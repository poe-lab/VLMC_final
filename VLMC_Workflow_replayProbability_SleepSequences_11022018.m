...
%% Isolate sleep segments of PC_post:
% Place cells remain in same order that they are input.


%% Build words from the sleep portion of spike data based on the max ISI setting:
max_isi = 0.05;
[words, W, wordsTimeBins, bin_size] = raster2avlW_02272018(PC_Sleep, max_isi);
...
%% Run replay analysis:
[replay, spindleWordsReplay] = detectReplayInWordsSyll_FosterWilsonMethod_06072018BG(BH_FDR, EschenkoSpindle,PC_Sleep);

%% Statistics
replayStats = replayStats_11022018(replay);
